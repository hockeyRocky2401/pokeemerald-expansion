...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_SUDOWOODO] =
    {
        ...
        // .abilities = { ABILITY_STURDY, ABILITY_ROCK_HEAD, ABILITY_RATTLED },
        .abilities = { ABILITY_VERDANT_POWER, ABILITY_ROCK_HEAD, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_BROWN,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .baseHP        = 65,
        .baseAttack    = 55,
        // .baseDefense   = CORSOLA_DEFENSES,95
        .baseDefense   = 95,
        .baseSpeed     = 35,
        .baseSpAttack  = 65,
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .abilities = { ABILITY_PICKUP, ABILITY_SAND_VEIL, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .abilities = { ABILITY_STURDY, ABILITY_SAND_VEIL, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_GRAY,
