...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_SKULL_BASH] =
    {
        ...
        .effect = EFFECT_TWO_TURNS_ATTACK,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 150 : 100,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_LEECH_LIFE] =
    {
        ...
        .effect = EFFECT_ABSORB,
        .power = B_UPDATED_MOVE_DATA >= GEN_7 ? 60 : 20,
        .type = TYPE_BUG,
        .accuracy = 100,
    ...
    [MOVE_LUSTER_PURGE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = (B_UPDATED_MOVE_DATA >= GEN_9) ? 100 : 70,
        .type = TYPE_PSYCHIC,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_POISON_TAIL] =
    {
        ...
        .description = COMPOUND_STRING(
            "Attacks with a poison-\n"
            "tipped tail. May also\n"
            "poison the foe."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_POISON,
    ...
    [MOVE_TAILWIND] =
    {
        ...
        .pp = B_UPDATED_MOVE_DATA >= GEN_6 ? 5 : 30,
        .target = MOVE_TARGET_USER,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_BOOST_CRITS },
    ...
    [MOVE_RAGING_FURY] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "that confuses the user."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 ? 110 : 90,
        .type = TYPE_FIRE,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_RANDOM,
    ...
    [MOVE_WAVE_CRASH] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 ? 110 : 75,
        .type = TYPE_WATER,
        .accuracy = 100,
        .recoil = 33,
        .pp = 10,
